...
for i=1:n
    for j=1:n
        ...
        if wij ~= 0
            ...
            M1t(i,j) = -1/(2*delta^2*wij^3*vij^3)*...
                (2*sin(1/2*wij*L-wij*delta + bij)*delta^2*vij^3*wij^2-...
            ...
            M1t(i,j)= 1/(48*delta^2*w1(i)^3)*(32*cos(bij)*delta^3*w1(i)^3 +...
        ...
        if wij ~= 0
            M2(i,j) = (sin(1/2*vij*L+vij*delta+cij)*wij-sin(1/2*wij*L+wij*delta+bij)*vij...
                - sin(vij*L+cij)*wij + sin(wij*L+bij)*vij)/(vij*wij);
            M2t(i,j)= 1/(2*delta^2*wij^3*vij^3)*...
                (2*sin(1/2*wij*L+wij*delta + bij)*delta^2*vij^3*wij^2-...
                2*sin(1/2*vij*L + vij*delta + cij)*delta^2*vij^2*wij^3+...
                2*cos(1/2*wij*L + wij*delta + bij)*delta*vij^3*wij-...
                2*cos(1/2*vij*L + vij*delta + cij)*delta*vij*wij^3-...
            ...
            M2(i,j)=(cos(bij)*w2(i)*L-2*cos(bij)*w2(i)*delta+...
                +sin(L*w2(i)+2*delta*w2(i)+cij)-sin(2*L*w2(i)+cij))/(2*w2(i));
            M2t(i,j)=1/(48*delta^2*w2(i)^3)*(32*cos(bij)*delta^3*w2(i)^3 -...
        ...
        cij = b1(i)+b2(j);
        if wij ~= 0
            M12(i,j)= - 1/(2*delta^2*wij^3*vij^3)*...
            ...
            M12(i,j)=1/(48*delta^2*w1(i)^3)*(16*cos(bij)*delta^3*w1(i)^3+...
